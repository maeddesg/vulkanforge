...
the correct 3-stage pipeline shape — delivered the +19 %. The
forward pass currently runs end-to-end on Qwen3 and Qwen2.5 (both
Q4_K_M); Llama / Mistral / DeepSeek GGUFs read cleanly via `info`
but `chat` is gated until the multi-arch sprint lands.
